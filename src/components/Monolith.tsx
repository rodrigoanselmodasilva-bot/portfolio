...
/**
 * Full brand glyph — matches the source SVG exactly.
 * Cropped to the figure (no rounded background), preserving original paths.
 */
export function Monolith({ size = 220 }: { size?: number }) {
  return (
    <motion.svg
      width={size}
      height={Math.round((size * 800) / 280)}
